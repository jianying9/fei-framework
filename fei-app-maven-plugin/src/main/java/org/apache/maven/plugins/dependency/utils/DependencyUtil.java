...
public final class DependencyUtil
{
     ...
     * @param removeVersion Specifies if the version should be removed from the
     * file name.
    ...
    /**
     * Builds the file name. If removeVersion is set, then the file name must be
     * reconstructed from the groupId (if
     * <b>prependGroupId</b> is true) artifactId, Classifier (if used) and Type.
     * Otherwise, this method returns the artifact file name.
     *
     * @param artifact File to be formatted.
     * @param removeVersion Specifies if the version should be removed from the
     * file name.
     * @param prependGroupId Specifies if the groupId should be prepended to the
     * file name.
     * @return Formatted file name in the format
     ...
     * Type. Otherwise, this method returns the artifact file name.
     *
     * @param artifact file to be formatted
     * @param removeVersion Specifies if the version should be removed from the
     * file name
     * @param prependGroupId Specifies if the groupId should be prepended to the
     * file name
     * @param useBaseVersion Specifies if the baseVersion of the artifact should
     * be used instead of the version
     * @return Formatted file name in the format
     * [groupId].artifactId-[version]-[classifier].[type]
     */
    public static String getFormattedFileName(Artifact artifact, boolean removeVersion, boolean prependGroupId,
     ...
     *
     * @param useSubdirsPerScope if a new sub directory should be used for each
     * scope.
     ...
     * repository layout, if set, other settings will be ignored.
