        ...
        extends AbstractDependencyMojo
{
     ...
     * dependencies,</li>
     * <li><code>compile</code> include scope gives compile, provided, and
     * system dependencies,</li>
     ...
     * dependencies,</li>
     * <li><code>system</code> include scope just gives system
     * dependencies.</li>
     * </ul>
     *
     * @since 2.0
     ...
     * dependencies,</li>
     * <li><code>compile</code> exclude scope excludes compile, provided, and
     * system dependencies,</li>
     ...
     * dependencies,</li>
     * <li><code>system</code> exclude scope just excludes system
     * dependencies.</li>
     * </ul>
     *
     * @since 2.0
     ...
     * otherwise.
     * @param includeParents <code>true</code> if parents should be included or
     * not <code>false</code>.
    ...
    /**
     * @param coordinates The set of artifact
     * coordinates{@link ArtifactCoordinate}.
     * @param stopOnFailure <code>true</code> if we should fail with exception
     * if an artifact couldn't be resolved <code>false</code> otherwise.
