        ...
        extends AbstractDependencyFilterMojo
{
     ...
     * @since 1.0
     */
    @Parameter(property = "outputDirectory", defaultValue = "${project.build.directory}/${project.build.finalName}/lib")
    ...
    /**
     * @param failOnMissingClassifierArtifact
     * {@link #failOnMissingClassifierArtifact}
     */
