 ...
 * under the License.
 */
import org.apache.maven.plugins.dependency.fromConfiguration.AbstractFromDependenciesMojo;
import java.io.File;
...
@Mojo(name = "copy-dependencies", requiresDependencyResolution = ResolutionScope.TEST, defaultPhase = LifecyclePhase.PACKAGE, threadSafe = true)
        ...
        extends AbstractFromDependenciesMojo
{
     ...
     * filename. Will only be used if {@link #isStripVersion()} is
     * {@code false}.
     *
     * @since 2.6
     */
     ...
     * boolean, boolean, boolean, File, Artifact)
     */
    protected void copyArtifact(Artifact artifact, boolean removeVersion, boolean prependGroupId,
