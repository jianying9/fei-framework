 ...
 * @author jianying9
 */
public final class IntegerValidationImpl extends AbstractParamValidation implements ParamValidation
{
    ...
    public IntegerValidationImpl(String key, String name, long max, long min, String description)
    {
        this.key = key;
        this.name = name;
